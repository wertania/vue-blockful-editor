<template>
  <ul class="max-w-md space-y-1 text-gray-500 list-inside">
    ...
    <li class="flex items-center">
      ...
      <i
        class="text-sm cursor-pointer rounded-xl bg-gray-200 p-[3px] hover:bg-gray-100 ml-3"
        @click="modelValue.data.scroll = 'xy'"
        >xy</i
      >
      <i
        class="text-sm cursor-pointer rounded-xl bg-gray-200 p-[3px] hover:bg-gray-100 ml-3"
        @click="modelValue.data.scroll = 'x'"
        >x</i
      >
      <i
        class="text-sm cursor-pointer rounded-xl bg-gray-200 p-[3px] hover:bg-gray-100 ml-3"
        @click="modelValue.data.scroll = 'y'"
        >y</i
      >
      <i
        class="text-sm cursor-pointer rounded-xl bg-gray-200 p-[3px] hover:bg-gray-100 ml-3"
        @click="modelValue.data.scroll = 'no'"
        >no</i
      >
    </li>
