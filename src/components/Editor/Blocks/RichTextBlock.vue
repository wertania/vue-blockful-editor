<template>
  <div v-if="editor" id="editor-toolbar">
    ...
    <i class="fa-solid fa-paragraph bg-gray-200 hover:bg-gray-100 rounded-sm cursor-pointer p-1 ml-1"
      @click="editor?.chain().focus().setParagraph().run()" :class="{ 'bg-gray-400': editor.isActive('paragraph') }" />
...
import { BlockRichText } from "../../../interfaces/blocks";
